...
void loop() {
  ...
  */
  ...
  value = levels(avg_temp, avg_speed, avg_overall_max_out, avg_overall_max_in, num_levels);
...
int levels(float avg_temp, float avg_speed, float avg_overall_max_out, float avg_overall_max_in, int num_levels) {
  /*
